...
class Page {
  ...
  render() {
    const layout = new __WEBPACK_IMPORTED_MODULE_0__Layout__["a" /* default */]( this.$app );
...
function renderPage(params={}) {
  ...
  const requestParams = params.requests || __WEBPACK_IMPORTED_MODULE_1_query_string___default.a.parse(location.search);
